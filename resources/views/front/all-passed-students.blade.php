...
<section class="directory-wrap">
    <div class="directory-panel">
        <div class="directory-header">
            <span class="directory-kicker">Alumni Network</span>
            <h1>All Passed Students</h1>
            <p>Showing all passed students in a mixed old and new order, 50 items per page.</p>
        </div>
            ...
            @foreach ($students as $student)
                <article class="directory-card">
                    <div class="directory-card__media">
                        <img src="{{ $student->photo_path ? asset('storage/' . $student->photo_path) : asset('default-avatar.png') }}" alt="{{ $student->name }}" loading="lazy">
                    </div>
