...
<div style="text-align: center; margin-top: 20px;">
    <h1 style="font-size: 2rem; font-weight: bold; margin-bottom: 20px;">Photos for {{ $category->name }}</h1>
</div>
    ...
    @foreach ($category->subCategories as $subCategory)
        ...
        onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 4px 10px rgba(0, 0, 0, 0.1)';">
            ...
            <div style="padding: 15px; text-align: center;">
                <!-- Link to view photos for the subcategory -->
                <a href="{{ route('subcategory.photos', ['category_id' => $category->id, 'subcategory_id' => $subCategory->id]) }}" 
