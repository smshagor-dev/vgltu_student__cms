...
@section('content')
<div class="container">
    <h1 class="text-primary">Users and Submitted Problems</h1>

    <!-- Search Form -->
    <form action="{{ route('admin.user-custom-data.index') }}" method="GET" class="mb-3">
...
<div style="max-width: 100%; padding: 20px; font-family: Arial, sans-serif;">
    <h2 style="margin-bottom: 20px; font-size: 1.8rem; text-align: center; color: #333;">Users Who Submitted Data</h2>
